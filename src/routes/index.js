...
export default (
  <Route path="/" component={App}>
    ...
    <Route path="/od.html/:tid/:id" component={OrderDetail} onEnter={utils.checkAuth} />
    ...
    <Route path="/order/logistics/:tradeId/:packageGroupKey" component={Logistics} onEnter={utils.checkAuth} />
