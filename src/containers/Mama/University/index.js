    ...
    return (
      <ul className="course-list">
        {courses.map((course, index) => {
          return (
            <li key={index} className="row no-margin bottom-border content-white-bg">
              ...
              <div className="col-xs-8">
                ...
                <p className="col-xs-12 no-margin no-padding padding-top-xxs font-xxs font-grey-light">
                  <span className="col-xs-5 no-padding text-left no-wrap">{course.num_attender + '人阅读'}</span>
                  <span className="col-xs-4 no-padding">小鹿美美</span>
                  <i className="col-xs-3 icon-share font-grey-light"></i>
                </p>
              </div>
            </li>
            );
